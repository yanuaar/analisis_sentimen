...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">Pencarian Target Tweet</div>
            <div class="card-body card-block">
                <form action="/cari_semua_proses" method="GET" class="">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Target Tweet Negatif</strong>
            </div>
            <div class="card-body">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Target Tweet Positif</strong>
            </div>
            <div class="card-body">
                <table class="table table-bordered">
                    <thead>
